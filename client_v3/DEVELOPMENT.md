# Development Guide — client_v3

This document explains how to set up a development environment for the
`client_v3` frontend, run it locally, and contribute code. It is intended for
...
- [Development Guide — client_v3](#development-guide--client_v3)
...
All commands in this guide are run from the `client_v3/` directory.

```sh
git clone https://github.com/AdguardTeam/AdGuardHome.git
cd AdGuardHome/client_v3
npm install
```
