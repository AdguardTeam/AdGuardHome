...
import { addFilter } from 'panel/actions/filtering';
...
export const ConfigureAllowlistModal = ({ modalId }: Props) => {
    ...
    const isOpen = useSelector((state: RootState) => state.modals.modalId === MODAL_TYPE.ADD_ALLOWLIST);
