...
export const Icons = () => (
    <svg xmlns="http://www.w3.org/2000/svg" class="icons">
        ...
        <symbol id="checkbox_on" viewBox="0 0 24 24" fill-rule="evenodd" clip-rule="evenodd">
            <path
        ...
        <symbol id="checkbox_minus" viewBox="0 0 24 24" fill-rule="evenodd" clip-rule="evenodd">
            <path
        ...
        <symbol id="checkbox_plus" viewBox="0 0 24 24" fill-rule="evenodd" clip-rule="evenodd">
            <path
        ...
        <symbol id="faq" viewBox="0 0 24 24" fill="none" fill-rule="evenodd" clip-rule="evenodd">
            <path
        ...
        <symbol id="logout" viewBox="0 0 24 24" fill="none" fill-rule="evenodd" clip-rule="evenodd">
            <path
                d="M15.5556 7L20 12"
                stroke="currentColor"
                stroke-width="1.5"
        ...
        <symbol id="lang" viewBox="0 0 24 24" fill="none" fill-rule="evenodd" clip-rule="evenodd">
            <path
                stroke="currentColor"
                stroke-linecap="round"
                stroke-linejoin="round"
                stroke-width="1.5"
                d="M13 14s2.53-.581 4.026-2.326S19 7 19 7"
            />
            <path
                stroke="currentColor"
                stroke-linecap="round"
                stroke-linejoin="round"
                stroke-width="1.5"
                d="M20 14s-2.53-.581-4.026-2.326S14 7 14 7M3 20l4.005-9L11 20"
            />
            <path stroke="currentColor" stroke-width="1.5" d="M4 17.5h5.5" />
            <path
                stroke="currentColor"
                stroke-linecap="round"
                stroke-width="1.5"
                d="M11.5 6.5h10M16.5 6V4.5"
            />
        </symbol>
        ...
        <symbol id="cross" viewBox="0 0 24 24" fill="none" fill-rule="evenodd" clip-rule="evenodd">
            <path
        ...
        <symbol id="settings_info" viewBox="0 0 64 64" fill="none">
            <path
                d="M47.88 25.37C48.27 26.17 48.59 27 48.86 27.85C49.05 28.45 49.52 28.92 50.13 29.1C52.07 29.68 53.52 30.22 54.4 30.59V35.8C53.52 36.16 52.07 36.71 50.13 37.28C49.52 37.46 49.05 37.93 48.86 38.53C48.54 39.57 48.12 40.58 47.61 41.55C47.32 42.11 47.32 42.78 47.62 43.33C48.58 45.12 49.22 46.53 49.59 47.4L45.91 51.08C45.04 50.72 43.62 50.08 41.85 49.11C41.29 48.81 40.62 48.8 40.06 49.11C39.09 49.62 38.09 50.03 37.05 50.36C36.45 50.55 35.97 51.02 35.79 51.63C35.22 53.57 34.67 55.02 34.31 55.9H29.1C28.74 55.02 28.19 53.57 27.62 51.63C27.44 51.02 26.96 50.55 26.37 50.36C25.32 50.04 24.32 49.62 23.35 49.11C23.07 48.97 22.78 48.89 22.46 48.89C22.14 48.89 21.83 48.97 21.57 49.12C19.78 50.09 18.37 50.73 17.5 51.09L13.82 47.4C14.18 46.54 14.81 45.14 15.76 43.38C16.09 42.81 16.1 42.1 15.77 41.51C15.28 40.57 14.87 39.59 14.56 38.58C14.38 37.94 13.88 37.44 13.23 37.27C11.31 36.7 9.87 36.15 9 35.8V30.59C9.88 30.23 11.33 29.68 13.27 29.11C13.88 28.93 14.36 28.45 14.54 27.86C14.86 26.81 15.28 25.81 15.79 24.84C16.08 24.28 16.08 23.61 15.78 23.05C14.82 21.27 14.18 19.86 13.81 18.99L17.49 15.31C18.36 15.67 19.78 16.31 21.55 17.28C22.1 17.59 22.77 17.59 23.33 17.29C24.3 16.78 25.31 16.37 26.35 16.04C26.96 15.85 27.44 15.36 27.61 14.74C28.19 12.81 28.73 11.37 29.09 10.5H34.3C34.66 11.38 35.21 12.83 35.78 14.77C35.96 15.38 36.44 15.85 37.03 16.04C37.54 16.2 38.04 16.37 38.53 16.58"
                stroke="currentColor"
                stroke-width="1.5"
                stroke-linejoin="round"
            />
            <path
                d="M31.7 27C28.28 27 25.51 29.77 25.51 33.19C25.51 36.61 28.28 39.38 31.7 39.38C35.12 39.38 37.89 36.61 37.89 33.19C37.89 29.77 35.12 27 31.7 27Z"
                stroke="currentColor"
                stroke-width="1.5"
                stroke-linejoin="round"
            />
            <path
                d="M47.76 23.26C51.6978 23.26 54.89 20.0678 54.89 16.13C54.89 12.1922 51.6978 9 47.76 9C43.8222 9 40.63 12.1922 40.63 16.13C40.63 20.0678 43.8222 23.26 47.76 23.26Z"
                stroke="currentColor"
                stroke-width="1.5"
                stroke-linecap="round"
                stroke-linejoin="round"
        ...
        <symbol id="copy" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g fill="none" fill-rule="evenodd" stroke="currentColor" stroke-width="1.5">
                ...
                <path d="m8 6.12528887v-.62528887c0-.82842712.67157288-1.5 1.5-1.5h8.5c1.1045695 0 2 .8954305 2 2v8c0 1.1045695-.8954305 2-2 2h-.265606" />
            </g>
        </symbol>
        ...
        <symbol id="router" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            />
            <path
                d="M7.03453 11.4077C7.31379 11.6695 7.77344 11.6344 8.04807 11.3683C9.05991 10.3878 10.4753 9.77871 12.0419 9.77871C13.5715 9.77871 14.9571 10.3595 15.9635 11.2996C16.24 11.5579 16.6928 11.5882 16.9688 11.3294C17.2043 11.1087 17.2263 10.7536 16.9958 10.5283C15.7445 9.30551 13.9875 8.54485 12.0419 8.54485C10.0504 8.54485 8.25666 9.34172 7.0005 10.6153C6.77768 10.8412 6.8025 11.1901 7.03453 11.4077Z"
                fill="currentColor"
            />
            <path
                d="M5.12672 9.61912C5.39921 9.87457 5.84491 9.85132 6.11303 9.5918C7.6157 8.13733 9.71674 7.23387 12.0419 7.23387C14.3286 7.23387 16.3986 8.10774 17.8958 9.52021C18.1651 9.77431 18.6061 9.79449 18.8763 9.54119C19.1183 9.31432 19.1348 8.94827 18.8962 8.71824C17.1564 7.04111 14.7283 6 12.0419 6C9.31095 6 6.84689 7.0759 5.10159 8.80213C4.86843 9.03274 4.88709 9.39447 5.12672 9.61912Z"
                fill="currentColor"
            />
        </symbol>
        ...
        <symbol id="eye_close" viewBox="0 0 24 24" fill="none">
            <path
                ...
                stroke-linecap="round"
            />
            <path d="M12 15V17" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
            <path d="M18 13V15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
            <path d="M6 13V15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
        </symbol>
        ...
        <symbol id="lock" viewBox="0 0 24 24" fill="none">
            <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M8.76647 9.28447C8.79941 7.77759 8.89727 5.97124 9.18576 5.28131C9.38401 4.8072 9.6612 4.442 10.0515 4.1883C10.4444 3.93287 11.0143 3.75 11.8654 3.75C12.7198 3.75 13.316 3.92761 13.7414 4.18547C14.1638 4.44146 14.4704 4.8082 14.6959 5.2763C15.0222 5.9538 15.1624 7.76486 15.2177 9.28176C14.1091 9.09111 13.0067 9 11.9998 9C10.9883 9 9.88026 9.09198 8.76647 9.28447ZM7.25894 9.60843C7.28534 7.97303 7.38968 5.6884 7.80188 4.70263C8.09035 4.01275 8.5397 3.38197 9.23392 2.93068C9.92546 2.48113 10.7979 2.25 11.8654 2.25C12.9295 2.25 13.8094 2.47268 14.5189 2.90267C15.2315 3.33454 15.7187 3.94322 16.0473 4.6254C16.5254 5.61798 16.6816 7.92734 16.7299 9.60556C17.5154 9.80862 18.2831 10.0648 19 10.3773C19 12.4227 19 21 11.9998 21C5 21 5 12.4234 5 10.3776L5 10.3773C5.71351 10.0663 6.47732 9.81104 7.25894 9.60843ZM12 13.25C12.4142 13.25 12.75 13.5858 12.75 14L12.75 16C12.75 16.4142 12.4142 16.75 12 16.75C11.5858 16.75 11.25 16.4142 11.25 16L11.25 14C11.25 13.5858 11.5858 13.25 12 13.25Z"
                fill="currentColor"
            />
        </symbol>

        <symbol id="tracking" viewBox="0 0 24 24" fill="none">
            <path
                d="M17.3918 9.16766C18.2612 9.86669 19.1306 10.7348 20 11.772C17.3333 15.1053 14.6667 16.772 12 16.772C11.5607 16.772 11.1214 16.7267 10.682 16.6363M8.17168 15.613C7.16728 14.9541 5.77673 13.6737 4 11.772C6.66667 8.59066 9.33333 7 12 7C13.0715 7 14.143 7.25682 15.2145 7.77047M4 21L20 3M10.5858 13.4142C10.2239 13.0523 10 12.5523 10 12C10 10.8954 10.8954 10 12 10C12.4707 10 12.9035 10.1626 13.2451 10.4348L10.5858 13.4142Z"
                stroke="currentColor"
                stroke-width="1.5"
                stroke-linecap="round"
                stroke-linejoin="round"
