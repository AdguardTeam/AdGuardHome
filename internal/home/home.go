...
func run(
	...
	err = initContextClients(ctx, slogLogger, sigHdlr, confModifier, workDir)
	fatalOnError(err)
	...
	err = setupDNSFilteringConf(ctx, slogLogger, config.Filtering, tlsMgr, confModifier, workDir)
	fatalOnError(err)
