...
func TestServer_ProcessInitial(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			gotRC := s.processInitial(testutil.ContextWithTimeout(t, testTimeout), dctx, testLogger)
...
func TestServer_ProcessFilteringAfterResponse(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			gotRC := s.processFilteringAfterResponse(ctx, dctx, testLogger)
			assert.Equal(t, tc.wantRC, gotRC)
...
func TestServer_ProcessDDRQuery(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			res := s.processDDRQuery(testutil.ContextWithTimeout(t, testTimeout), dctx, testLogger)
...
func TestServer_ProcessDHCPHosts_localRestriction(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			res := s.processDHCPHosts(testutil.ContextWithTimeout(t, testTimeout), dctx, testLogger)
...
func TestServer_ProcessUpstream_localPTR(t *testing.T) {
	...
	t.Run("enabled", func(t *testing.T) {
		...
		ctx := testutil.ContextWithTimeout(t, testTimeout)
		pctx := newPrxCtx()
		rc := s.processUpstream(ctx, &dnsContext{proxyCtx: pctx}, testLogger)
